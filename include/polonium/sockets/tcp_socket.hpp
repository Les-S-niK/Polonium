...
class TcpIpv4Socket {
   public:
     ...
     * @param flags
     *
     * @return std::string: received data as string.
     */
   ...
   private:
    /**
     * @brief Write occured error in log file and throw an exception.
     *
